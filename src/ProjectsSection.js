...
function ProjectsSection({
  ...
  return (
    <section className="projects-section " id="section-1">
      <div
        className="projects-section-container animation-opacity"
        id="section-1"
        style={{
          backgroundImage: bg,
      ...
      <div className="projects-dots">
        <Dot
          activeClass={count === 1 ? "active-dot" : ""}
          num={1}
          setCount={setCount}
        />
        <Dot
          activeClass={count === 2 ? "active-dot" : ""}
          num={2}
          setCount={setCount}
        />
        <Dot
          activeClass={count === 3 ? "active-dot" : ""}
          num={3}
          setCount={setCount}
        />
        <Dot
          activeClass={count === 4 ? "active-dot" : ""}
          num={4}
          setCount={setCount}
        />
        <Dot
          activeClass={count === 5 ? "active-dot" : ""}
          num={5}
          setCount={setCount}
        />
      </div>
